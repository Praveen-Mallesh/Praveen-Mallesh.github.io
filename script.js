...
function renderProjects() {
    ...
    projectsToShow.forEach(project => {
        ...
        // Support both icon classes (Font Awesome) and image paths (e.g., SVG)
        let imageHtml = '';
        if (project.image && typeof project.image === 'string' && project.image.toLowerCase().endsWith('.svg')) {
            imageHtml = `<img src="${project.image}" alt="${project.title} logo" class="project-svg">`;
        } else if (project.image) {
            imageHtml = `<i class="${project.image}"></i>`;
        }
